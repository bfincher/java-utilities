...
public class TcpServerChannel extends TcpChannel {
     ...
     *                     will be used
     */
    protected TcpServerChannel(String id, IoType ioType, StreamIo streamIo, InetSocketAddress localAddress) {
     ...
     */
    public static TcpServerChannel createChannel(String id, StreamIo streamIo, InetSocketAddress localAddress) {
     ...
     * @return a new TCP server socket that is capable of both sending and receiving data
     */
    public static TcpServerChannel createChannel(String id, Consumer<MessageBuffer> messageHandler, StreamIo streamIo,
    ...
    public InetSocketAddress getlocalAddress() {
        if (connectThread != null) {
            TcpServerConnectRunnable connectRunnable = (TcpServerConnectRunnable) connectThread.getCallable()
                    .orElseThrow();
